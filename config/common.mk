...
# Include font files
include vendor/minus/config/fonts.mk
...
# Require all requested packages to exist_manifest.xml rild
$(call enforce-product-packages-exist-internal,$(wildcard device/*/$(MINUS_BUILD)/$(TARGET_PRODUCT).mk),product Calendar Launcher3 Launcher3Go Launcher3QuickStep Launcher3QuickStepGo android.hidl.memory@1.0-impl.vendor vndk_apex_snapshot_package)
endif
...
PRODUCT_COPY_FILES += \
    vendor/minus/prebuilt/common/etc/init/init.minus-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.minus-updater.rc
